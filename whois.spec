...
Version  : 5.5.6
Release  : 12
URL      : https://github.com/rfc1036/whois/archive/v5.5.6/whois-5.5.6.tar.gz
Source0  : https://github.com/rfc1036/whois/archive/v5.5.6/whois-5.5.6.tar.gz
...
%prep
%setup -q -n whois-5.5.6
cd %{_builddir}/whois-5.5.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581996440
...
cp %{_builddir}/whois-5.5.6/COPYING %{buildroot}/usr/share/package-licenses/whois/4cc77b90af91e615a64ae04893fdffa7939db84c
