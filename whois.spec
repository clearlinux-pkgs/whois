...
Version  : 5.5.15
Release  : 21
URL      : https://github.com/rfc1036/whois/archive/v5.5.15/whois-5.5.15.tar.gz
Source0  : https://github.com/rfc1036/whois/archive/v5.5.15/whois-5.5.15.tar.gz
...
%prep
%setup -q -n whois-5.5.15
cd %{_builddir}/whois-5.5.15
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672336957
