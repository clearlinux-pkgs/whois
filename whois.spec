...
Version  : 5.6.0
Release  : 30
URL      : https://github.com/rfc1036/whois/archive/v5.6.0/whois-5.6.0.tar.gz
Source0  : https://github.com/rfc1036/whois/archive/v5.6.0/whois-5.6.0.tar.gz
...
%prep
%setup -q -n whois-5.6.0
cd %{_builddir}/whois-5.6.0
pushd ..
cp -a whois-5.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746455081
