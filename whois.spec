...
Version  : 5.5.23
Release  : 29
URL      : https://github.com/rfc1036/whois/archive/v5.5.23/whois-5.5.23.tar.gz
Source0  : https://github.com/rfc1036/whois/archive/v5.5.23/whois-5.5.23.tar.gz
...
%prep
%setup -q -n whois-5.5.23
cd %{_builddir}/whois-5.5.23
pushd ..
cp -a whois-5.5.23 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715632347
