...
Source0  : https://github.com/rfc1036/whois/archive/v5.5.20/whois-5.5.20.tar.gz
...
%prep
%setup -q -n whois-5.5.20
cd %{_builddir}/whois-5.5.20
pushd ..
cp -a whois-5.5.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699904758
