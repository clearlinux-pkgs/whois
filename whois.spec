...
Version  : 5.5.8
Release  : 14
URL      : https://github.com/rfc1036/whois/archive/v5.5.8/whois-5.5.8.tar.gz
Source0  : https://github.com/rfc1036/whois/archive/v5.5.8/whois-5.5.8.tar.gz
...
%prep
%setup -q -n whois-5.5.8
cd %{_builddir}/whois-5.5.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613495406
...
cp %{_builddir}/whois-5.5.8/COPYING %{buildroot}/usr/share/package-licenses/whois/4cc77b90af91e615a64ae04893fdffa7939db84c
