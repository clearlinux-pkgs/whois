...
Version  : 5.5.14
Release  : 20
URL      : https://github.com/rfc1036/whois/archive/v5.5.14/whois-5.5.14.tar.gz
Source0  : https://github.com/rfc1036/whois/archive/v5.5.14/whois-5.5.14.tar.gz
...
%prep
%setup -q -n whois-5.5.14
cd %{_builddir}/whois-5.5.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666024588
