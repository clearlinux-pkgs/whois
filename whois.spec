...
Version  : 5.5.19
Release  : 25
URL      : https://github.com/rfc1036/whois/archive/v5.5.19/whois-5.5.19.tar.gz
Source0  : https://github.com/rfc1036/whois/archive/v5.5.19/whois-5.5.19.tar.gz
...
%prep
%setup -q -n whois-5.5.19
cd %{_builddir}/whois-5.5.19
pushd ..
cp -a whois-5.5.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696867254
