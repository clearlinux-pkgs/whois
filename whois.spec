...
Version  : 5.6.1
Release  : 31
URL      : https://github.com/rfc1036/whois/archive/v5.6.1/whois-5.6.1.tar.gz
Source0  : https://github.com/rfc1036/whois/archive/v5.6.1/whois-5.6.1.tar.gz
...
%prep
%setup -q -n whois-5.6.1
cd %{_builddir}/whois-5.6.1
pushd ..
cp -a whois-5.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747670592
