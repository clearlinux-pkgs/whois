...
Version  : 5.5.21
Release  : 27
URL      : https://github.com/rfc1036/whois/archive/v5.5.21/whois-5.5.21.tar.gz
Source0  : https://github.com/rfc1036/whois/archive/v5.5.21/whois-5.5.21.tar.gz
...
%prep
%setup -q -n whois-5.5.21
cd %{_builddir}/whois-5.5.21
pushd ..
cp -a whois-5.5.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708973105
