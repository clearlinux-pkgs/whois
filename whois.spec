...
Version  : 5.5.4
Release  : 9
URL      : https://github.com/rfc1036/whois/archive/v5.5.4/whois-5.5.4.tar.gz
Source0  : https://github.com/rfc1036/whois/archive/v5.5.4/whois-5.5.4.tar.gz
...
%prep
%setup -q -n whois-5.5.4
cd %{_builddir}/whois-5.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578161315
...
cp %{_builddir}/whois-5.5.4/COPYING %{buildroot}/usr/share/package-licenses/whois/4cc77b90af91e615a64ae04893fdffa7939db84c
